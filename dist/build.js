...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return handleCollision; });\n/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../main.js */ \"./src/main.js\");\n\n\nlet dx;\nlet dy;\nlet distance;\nlet score = 0;\n\n// collision detection function \nfunction handleCollision() {\n\n    // for (var i = 0; i < foodCirclesArr.length; i++) {\n    for (let i = _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"].length - 1; i >= 0; i--) {\n\n        dx = _main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].x - _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].x;\n        dy = _main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].y - _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].y;\n        distance = Math.sqrt(dx * dx + dy * dy);\n\n        function removeFoodItem() {\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].save();\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].globalCompositeOperation = 'destination-out';\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].beginPath();\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].arc(_main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].x, _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].y, _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].r + 1, 0, 2 * Math.PI, false);\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].clip();\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].fill();\n            _main_js__WEBPACK_IMPORTED_MODULE_0__[\"ctx\"].restore();\n        }\n\n        if (distance < (_main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].r + 1) + _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].r) {\n\n            if (_main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].r + 1 > _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"][i].r) {\n                removeFoodItem()\n                growPlayerMass();\n                //update player's score\n               score+=5;\n                console.log(score);\n\n                document.getElementById('score').innerHTML = \"Score: \" + score;\n                //remove foodItem from array \n                if (i > -1) {\n                    _main_js__WEBPACK_IMPORTED_MODULE_0__[\"foodCirclesArr\"].splice(i, 1);\n                }\n            }\n\n            console.log(\"Collision detected!\");\n            // console.log(\"Food item X\" + foodCirclesArr[i].x, \"Food item Y\" + foodCirclesArr[i].y);\n            console.log(\"foodItem Index:\" + i);\n        }\n\n    }\n}\n\n//function to grow player's mass \nfunction growPlayerMass() {\n    _main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].r += _main_js__WEBPACK_IMPORTED_MODULE_0__[\"extraMass\"];\n    _main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].draw(_main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].r);\n    console.log(\"extraMass:\" + _main_js__WEBPACK_IMPORTED_MODULE_0__[\"extraMass\"], \"current Mass:\" + _main_js__WEBPACK_IMPORTED_MODULE_0__[\"playerCoords\"].r);\n}\n\n//# sourceURL=webpack:///./src/modules/handleCollision.js?");
